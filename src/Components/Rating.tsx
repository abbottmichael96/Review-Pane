...
export function Rating() {
    ...
    <>
        ...
        <p className={styles.bodytext}>
            ...
            Coded by <a href="https://github.com/abbottmichael96">Michael Abbott</a>.
        </p>
    </>
    ) : ( 
        <>
